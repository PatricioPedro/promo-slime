import 'package:promo_ecommerce/common/helper/images/image_display.dart';
import 'package:promo_ecommerce/domain/order/entities/product_ordered.dart';
import 'package:promo_ecommerce/presentation/cart/bloc/cart_products_display_cubit.dart';
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                      'AOA${productOrderedEntity.totalPrice}',
                      style: const TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 14
                      ),
