...
import 'package:promo_ecommerce/domain/order/entities/order.dart';
import 'package:promo_ecommerce/presentation/settings/pages/order_items.dart';
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            '${orderEntity.products.length} Itens',
