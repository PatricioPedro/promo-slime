...
import 'package:promo_ecommerce/common/helper/bottomsheet/app_bottomsheet.dart';
...
import 'package:promo_ecommerce/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:promo_ecommerce/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:promo_ecommerce/presentation/auth/bloc/gender_selection_cubit.dart';
import 'package:promo_ecommerce/presentation/auth/widgets/ages.dart';
  ...
  Widget _genders(BuildContext context) {
    return BlocBuilder<GenderSelectionCubit,int>(
      builder: (context,state) {
        ...
        children: [
          genderTile(context,1,'Homem'),
          const SizedBox(width: 20,),
          genderTile(context,2,'Mulher'),
        ],
      );
      }
