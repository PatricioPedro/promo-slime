...
import 'package:promo_ecommerce/presentation/product_detail/pages/product_detail.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            productEntity.discountedPrice == 0 ? "${productEntity.price}AOA" :
                            "${productEntity.discountedPrice}AOA",
                            style: const TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w300,
                            ),
